...
export type ItemsQuery = { __typename?: 'RootQueryType', itemList?: Array<{ __typename?: 'Item', name?: string | null, price: number, id: string, owner?: { __typename?: 'User', username: string } | null }> | null };
